...
export default function NotificationSettingsScreen() {
  ...
  // State for switches (replace with actual state logic if needed)
          ...
          >
            <YStack space="$3">
              <XStack justifyContent="space-between" alignItems="center">
                ...
                <Switch size="$3" checked={mealPrep} onCheckedChange={setMealPrep} />
              </XStack>
              ...
              <XStack justifyContent="space-between" alignItems="center">
                ...
                <Switch size="$3" checked={weeklySuggestions} onCheckedChange={setWeeklySuggestions} />
              </XStack>
            </YStack>
          </Card>
        </YStack>
